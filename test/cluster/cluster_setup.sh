...
function cluster-setup {
    ...
    cluster_params=$(jsonnet "$HERE/cluster-template.jsonnet" \
        ...
        --ext-str os_image_alinux3="${OS_IMAGE_ALINUX3:-aliyun_3_x64_20G_container_optimized_alibase_20250629.vhd}" \
        --ext-str os_image_alinux3_arm64="${OS_IMAGE_ALINUX3_ARM64:-aliyun_3_arm64_20G_alibase_20240528.vhd}" \
        --ext-str os_image_containeros3="${OS_IMAGE_CONTAINEROS3:-lifsea_3_x64_5G_alibase_20250916.qcow2}" \
