...
func (cs *controllerServer) ControllerPublishVolume(ctx context.Context, req *csi.ControllerPublishVolumeRequest) (*csi.ControllerPublishVolumeResponse, error) {
	...
	if isMultiAttach {
		_, err := attachMultiAttachDisk(ctx, req.VolumeContext[TenantUserUID], req.VolumeId, req.NodeId)
		if err != nil {
	...
	_, err := attachDisk(ctx, req.VolumeContext[TenantUserUID], req.VolumeId, req.NodeId, isSingleInstance, false)
	if err != nil {
