...
func (cs *controllerServer) CreateVolume(ctx context.Context, req *csi.CreateVolumeRequest) (*csi.CreateVolumeResponse, error) {
	...
	diskID, attempt, err := cs.cloud.createDisk(ctx, cs.ecs, req.GetName(), snapshotID, diskVol, supportedTypes, selectedInstance, isVirtualNode)
	if err != nil {
...
func (cs *controllerServer) DeleteVolume(ctx context.Context, req *csi.DeleteVolumeRequest) (*csi.DeleteVolumeResponse, error) {
	...
	if GlobalConfigVar.DetachBeforeDelete {
		...
		if disk.Status == DiskStatusInuse && canDetach {
			...
			err := cs.cloud.detachDisk(ctx, cs.ecs, req.VolumeId, disk.InstanceId, false)
			if err != nil {
	...
	_, err := cs.cloud.deleteDisk(ctx, cs.ecs, req.VolumeId)
	if err != nil {
		newErrMsg := utils.FindSuggestionByErrorMessage(err.Error(), utils.DiskDelete)
...
func (cs *controllerServer) ControllerUnpublishVolume(ctx context.Context, req *csi.ControllerUnpublishVolumeRequest) (*csi.ControllerUnpublishVolumeResponse, error) {
	// Describe Disk Info
	isMultiAttach, err := cs.cloud.detachMultiAttachDisk(ctx, cs.ecs, req.VolumeId, req.NodeId)
	...
	err = cs.cloud.detachDisk(ctx, cs.ecs, req.VolumeId, req.NodeId, false)
	if err != nil {
