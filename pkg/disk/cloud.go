...
func attachDisk(ctx context.Context, diskID, nodeID string, isSingleInstance bool, fromNode bool) (string, error) {
...
func attachMultiAttachDisk(ctx context.Context, diskID, nodeID string) (string, error) {
