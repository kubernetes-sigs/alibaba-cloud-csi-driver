...
type DiskAttachDetach struct {
	...
	attachThrottler throttler
	detachThrottler throttler
}

// attach alibaba cloud disk
func (ad *DiskAttachDetach) attachDisk(ctx context.Context, tenantUserUID, diskID, nodeID string, isSharedDisk, isSingleInstance bool, fromNode bool) (string, error) {
