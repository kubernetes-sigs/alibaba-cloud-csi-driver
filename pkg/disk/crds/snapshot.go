...
// GetVolumeSnapshotClassesCRD ...
func (temp *Template) GetVolumeSnapshotClassesCRD() string {
...
// GetVolumeSnapshotContentsCRD ...
func (temp *Template) GetVolumeSnapshotContentsCRD() string {
...
// GetVolumeSnapshotsCRD ...
func (temp *Template) GetVolumeSnapshotsCRD() string {
	return `
    apiVersion: apiextensions.k8s.io/v1
    kind: CustomResourceDefinition
    metadata:
