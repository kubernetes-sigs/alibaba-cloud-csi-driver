...
func (ns *nodeServer) NodeStageVolume(ctx context.Context, req *csi.NodeStageVolumeRequest) (*csi.NodeStageVolumeResponse, error) {
	...
	if GlobalConfigVar.ADControllerEnable || isMultiAttach || serial != "" {
		...
		device, err = DefaultDeviceManager.GetDeviceBySerial(serial)
		if err != nil {
			if IsVFNode() {
...
func (ns *nodeServer) NodeUnstageVolume(ctx context.Context, req *csi.NodeUnstageVolumeRequest) (*csi.NodeUnstageVolumeResponse, error) {
	...
	if device != "" {
		...
		hasSerial, _ := deviceHasSerialNumber(device)
		if hasSerial {
	...
	err = detachDisk(ctx, ecsClient, req.VolumeId, ns.NodeID, true)
	if err != nil {
