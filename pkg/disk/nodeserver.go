...
func (ns *nodeServer) NodeUnstageVolume(ctx context.Context, req *csi.NodeUnstageVolumeRequest) (*csi.NodeUnstageVolumeResponse, error) {
	...
	// Teardown DataCache: flush writeback dirty blocks then remove dm-cache device.
	if cacheErr := teardownDataCache(ctx, logger, defaultCacheIO, req.VolumeId); cacheErr != nil {
		logger.Error(cacheErr, "teardown DataCache failed, continuing with unstage", "volumeId", req.VolumeId)
	}
