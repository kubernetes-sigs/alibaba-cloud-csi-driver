...
func Test_GetMountProxySocketPath(t *testing.T) {
	tests := []struct {
		...
		{"volume1", OssFuseAttachDir, "/run/fuse.ossfs/022a36dfadf09ba4bf2549819660fea3ded8a9fc2ac564db0ca90af906b2a29a/mounter.sock"},
		{"volume2", OssFuseAttachDir, "/run/fuse.ossfs/c1d2b5f1fd180bacb639735c65d0359b40115b1be2d4b98f0eb8dd0269f42534/mounter.sock"},
		{"volume1", CustomFuseAttachDir, "/run/fuse.customfuse/022a36dfadf09ba4bf2549819660fea3ded8a9fc2ac564db0ca90af906b2a29a/mounter.sock"},
	}

	for _, test := range tests {
		// Reset to default before each test
		SetFuseAttachBaseDir("/run")
		actual := GetMountProxySocketPath(test.volumeId, test.attachDir)
...
func Test_GetAttachPath(t *testing.T) {
	tests := []struct {
		...
		{"volume1", OssFuseAttachDir, "/run/fuse.ossfs/022a36dfadf09ba4bf2549819660fea3ded8a9fc2ac564db0ca90af906b2a29a/globalmount"},
		{"volume2", OssFuseAttachDir, "/run/fuse.ossfs/c1d2b5f1fd180bacb639735c65d0359b40115b1be2d4b98f0eb8dd0269f42534/globalmount"},
		{"volume1", CustomFuseAttachDir, "/run/fuse.customfuse/022a36dfadf09ba4bf2549819660fea3ded8a9fc2ac564db0ca90af906b2a29a/globalmount"},
	}

	for _, test := range tests {
		// Reset to default before each test
		SetFuseAttachBaseDir("/run")
		actual := GetAttachPath(test.volumeId, test.attachDir)
		assert.Equal(t, test.expected, actual)
	}
}
...
func Test_SetFuseAttachBaseDir(t *testing.T) {
	...
	volumeId := "volume1"
	actualPath := GetAttachPath(volumeId, OssFuseAttachDir)
