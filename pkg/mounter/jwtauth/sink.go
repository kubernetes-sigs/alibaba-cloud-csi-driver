...
// each driver supplies its own sink next to its mount wiring. NAS/CPFS, the
// only implementation today, pushes the rotated credential to the live alinas
// mount by executing the vendor refresh command (see the interceptors package).
