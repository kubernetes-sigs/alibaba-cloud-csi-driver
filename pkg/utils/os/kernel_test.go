...
func TestParseKernelVersion(t *testing.T) {
	tests := []struct {
		...
		{
			name:       "Alibaba Cloud Linux 3 x86_64",
			release:    "5.10.134-19.al9.x86_64",
			wantMajor:  5,
			wantMinor:  10,
			wantPatch:  134,
			wantSub:    19,
...
func TestCheckKernelForRecovery_ValidationError(t *testing.T) {
	tests := []struct {
		...
		{"valid al9 x86_64", "5.10.134-18.al9.x86_64", "x86_64", false},
		{"valid al10 x86_64", "5.10.134-18.al10.x86_64", "x86_64", false},
