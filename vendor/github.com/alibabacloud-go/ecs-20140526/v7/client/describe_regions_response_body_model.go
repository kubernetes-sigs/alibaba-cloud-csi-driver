...
func (s *DescribeRegionsResponseBodyRegionsRegion) GetStatus() *string {
	return s.Status
}
...
func (s *DescribeRegionsResponseBodyRegionsRegion) SetStatus(v string) *DescribeRegionsResponseBodyRegionsRegion {
	s.Status = &v
	return s
}
