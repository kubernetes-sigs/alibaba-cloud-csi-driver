...
ossplugin.csi.aliyun.com can be compiled in a form of a container.
...
> "host": logs will be printed into files which save to host(/var/log/alicloud/ossplugin.csi.aliyun.com.log);
...
Source:
    ...
    Driver:        ossplugin.csi.aliyun.com
